...
- [changed-2026-07-16-aideo-models-extraction.md](changes/changed-2026-07-16-aideo-models-extraction.md) — 提取跨平台本地模型库、修复 Faster-Whisper2 导入与本地路径、服务端推理日志及 CUDA 动态库启动、升级 Runtime SSE 依赖并强化 Linux 启动脚本。
