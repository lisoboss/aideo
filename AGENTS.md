...
`AGENTS.md` is kept simple and `.Codex/rules/` is split by modules.

See `.Codex/rules/` for conventions and per-module architecture:

| File | Module |
|------|--------|
| [architecture.md](.Codex/rules/architecture.md) | Overview + shared concepts |
| [architecture-serv.md](.Codex/rules/architecture-serv.md) | aideo-serv backend |
| [architecture-runtime.md](.Codex/rules/architecture-runtime.md) | aideo-runtime + CLI |
| [architecture-ipad.md](.Codex/rules/architecture-ipad.md) | aideo-ipad client |
| [conventions.md](.Codex/rules/conventions.md) | Code conventions |
